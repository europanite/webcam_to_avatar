...
The following table shows which versions of `webcam_to_avatar` are currently being supported with security updates.
...
We deeply appreciate the efforts of security researchers and contributors who help us improve the security of `webcam_to_avatar`.
