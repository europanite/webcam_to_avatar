<!-- P2M_REPORT -->
<!-- GENERATED at 2025-11-11 19:33:21 -->
# Project Export: vre
...
- Files: **40**
- Total size: **7638379 bytes**
- Total LOC: 1372 | SLOC: 1162 | TODOs: 0
...
- `frontend/app/public/avatar.vroid` — 7594221 bytes
- `LICENSE` — 11340 bytes
- `.gitignore` — 4688 bytes
- `CODE_OF_CONDUCT.md` — 4085 bytes
- `frontend/app/src/VrmSpeaker.web.tsx` — 4013 bytes
...
- `.gitignore` — 207 LOC
- `LICENSE` — 201 LOC
- `frontend/app/src/VrmSpeaker.web.tsx` — 135 LOC
- `README.md` — 88 LOC
...
- 30. [frontend/app/public/avatar.vroid](#frontend-app-public-avatar.vroid)
...
<a id="frontend-app-public-avatar.vroid"></a>
### 30. `frontend/app/public/avatar.vroid`
- Size: 7594221 bytes | LOC: 0 | SLOC: 0 | TODOs: 0 | Modified: 2025-11-11 19:24:54 | SHA1: 
#### Content
...
- Size: 4013 bytes | LOC: 135 | SLOC: 108 | TODOs: 0 | Modified: 2025-11-11 19:19:23 | SHA1: bc5259dd4dd5
...
const VRM_URL = "/avatar.vrm"; // GitHub Pages のルートに置く
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (gltf: any) => {
        ...
        vrm.scene.rotation.y = Math.PI; // 正面向ける
        scene.add(vrm.scene);
        vrmRef.current = vrm;
    ...
    const animate = () => {
      ...
      if (vrmRef.current) {
        ...
        vrmRef.current.expressionManager?.setValue("blink", blink);

        // 簡易口パク（喋ってる間だけ開閉）
        if (speakingRef.current) {
          const mouth = (Math.sin(t * 10) + 1) / 2;
          vrmRef.current.expressionManager?.setValue("aa", mouth);
        } else {
